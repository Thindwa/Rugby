...
@section('content')
@php $headerImage = $randomImage ? asset('storage/' . ($randomImage->hasWebpVariant() ? $randomImage->getWebpShortPath() : $randomImage->getShortPath())) : asset('img/carousel-2.jpg'); @endphp
